...
public class ReminderAddActivity extends AppCompatActivity implements
    ...
    public void saveReminder(){
        ...
        // Creating Reminder
        int ID = rb.addReminder(new Reminder(mTitle, mDescription, mDate, mTime, mRepeat, mRepeatNo, mRepeatType, mActive));
        ...
        Toasty.success(getApplicationContext(), "Task Saved",
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().trim().length() == 0)
                    ...
                    //mDescriptionText.setError("Reminder Description cannot be blank!");
